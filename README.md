...
## Handoff para la próxima conversación (actualizado 12-ago-2026)
...
- Las 4 páginas del dashboard (`dashboard/dashboard_riesgo_sla.pbix`) tienen contenido cerrado: Resumen Ejecutivo, Riesgo por Zona, Riesgo por Estación y Franja, Estado del Modelo.
- Pendiente, tarjeta "Pulir dashboard" del Kanban (única tarjeta en "En curso esta semana" al cierre de esta sesión): (1) rehacer el gráfico "Top 10 zonas de riesgo" en Riesgo por Zona — quedó roto y se eliminó, ver nota arriba; (2) mapa de calor (formato condicional) sobre `% Incumplimiento SLA` en la matriz de Riesgo por Estación y Franja — decidido con Fede, no construido.
